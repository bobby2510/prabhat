   ...
   // console.log(props.teamData)
    ...
    return (
        ...
        <div className='team-style'>
            ...
            <div className={get_class()} style={{position:'relative'}}>
                <div style={{position:'absolute',top:5,left:10,right:10}}>
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                    <span className='player-info'>Pre Points: {props.teamData.pre_points}</span>
                    <span className='player-info'>Leverage: {props.teamData.leverage}</span>
                </div>
                </div>
